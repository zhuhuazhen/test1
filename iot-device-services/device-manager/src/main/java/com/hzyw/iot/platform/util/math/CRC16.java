...
public class CRC16 {
    ...
    private static final byte[] TABLE_CRC_HI = {
    ...
    private static final byte[] TABLE_CRC_LO = {
    ...
    public static String crc16_modBus(byte[] data) {
        int crc = 0x0000ffff;
        int ucCRCHi = 0x00ff;
        int ucCRCLo = 0x00ff;
        int iIndex;
        for (int i = 0; i < data.length; ++i) {
            ...
            ucCRCLo = ucCRCHi ^ TABLE_CRC_HI[iIndex];
            ucCRCHi = TABLE_CRC_LO[iIndex];
        }
        crc = ((ucCRCHi & 0x00ff) << 8) | (ucCRCLo & 0x00ff) & 0xffff;
        //高低位互换，输出符合相关工具对Modus CRC16的运算
