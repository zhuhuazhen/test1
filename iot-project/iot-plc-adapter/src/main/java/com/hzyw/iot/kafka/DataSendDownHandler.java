...
public class DataSendDownHandler  {
    ...
    public static void process(final String message,final RedisService redisService) {
    	Runnable requestTask = new Runnable() {
			...
			public void run() {
				...
				try {
					...
					//CommandHandler.writeCommandByRequestMessageVO(plcTest); //提供了另一种下发方式
					TpsCountUtils.plcSendDownSetIncr(redisService, "plcSendDown_", 60*10);//统计1分钟请求量    
				} catch (Exception e) {
